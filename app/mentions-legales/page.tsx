      ...
      <div className="max-w-3xl mx-auto px-6 py-16 space-y-10" style={{ fontFamily: 'var(--font-jakarta)', color: '#1A1A1A' }}>
        <section>
          ...
          <p className="text-sm leading-relaxed" style={{ color: '#9A9590' }}>
            ...
            Luca Benattar — <a href="tel:+33616363487" style={{ color: '#C9A96E' }}>06 16 36 34 87</a> · <a href="mailto:luca.benattar@gmail.com" style={{ color: '#C9A96E' }}>luca.benattar@gmail.com</a>
          </p>
        </section>
